(function(storyContent) {
    ...
    function continueStory(firstTime) {
        ...
        while(story.canContinue) {
            ...
            delay += 200.0;
            // if (paragraphElement == '<img src="57d57002-d6a2-4dbb-a80f-f4928ded03c6.jif" class="cover">') {
                   
                
            // console.log(paragraphElement);
            // console.log(paragraphText);
            // if (paragraphText == "Sadhuta ni Murti") {
            //     storyContainer.classList.add("info");
            //     console.log(paragraphText);
            // }
                // storyContainer.innerHTML = paragraphElement;
